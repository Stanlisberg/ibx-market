  ...
  return (
    ...
    <div className='hero border border-purple-600 mt-[60px] flex flex-col justify-center items-center xl:justify-between'>
      <div className='border-2 border-green-800 sm:w-[500px] lg:px-0 lg:mb-32'>
        ...
        <div className='flex border-red-700 xl:w-[500px] border items-center relative mt-[2px]'>
          ...
          <div className='w-[76px] h-9 px-3.5 py-2 origin-top-left rotate-[20deg] text-amber-500 bg-amber-500 bg-opacity-5 rounded-[50px] justify-start items-center gap-2 inline-flex absolute bottom-[70px] left-[240px] sm:left-[280px]'>Booked</div>
        </div>
      </div>
      <div className='border border-red-950 xl:w-[600px] mt-[60px] lg:mt-[0px]'> 
